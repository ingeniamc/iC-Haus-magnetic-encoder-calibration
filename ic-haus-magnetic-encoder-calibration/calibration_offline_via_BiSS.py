...
dictionary_path = "C:\GitProjects\MU_3SL_interface_3.4.2\wrapper\python\examples\dr3247b-30_48-e_1.1.0_v3.xdf"
...
def extract_master_nonius_from_payload(payload_val) -> Tuple[int, int]:
    """
    Extract 14-bit master and nonius from a value that contains either:
      - lower 28 bits (master+nonius), or
      - full 32-bit payload (lower 28 bits carry master+nonius, upper 4 are padding).
    We treat the integer as LSB-aligned.
    """
    # If the value is larger than 28 bits but within 32 bits, we still only use the lower 28.
    # payload_val_noCRC = payload_val >> 10
    # lower_28 = payload_val_noCRC & ((1 << RAW_TOTAL) - 1)
...
def split_channel_data(channel_data: List[List[int]]) -> List[Tuple[int, int]]:
    """
    channel_data: nested list of integers. Each element is a packed value as read
    from your interface that holds at least the lower 28 bits of (master+nonius).
    Returns list of (master, nonius).
    """
    pairs = []
...
def configure_IC():
    ...
    time.sleep(0.1)
    initial_enac = mc.communication.get_register('FBK_BISS1_SSI1_ITF_DATA', axis=1) & 0xFF
    ...
    mc.communication.set_register('FBK_BISS1_SSI1_ITF_CTL', READ_ACTION, axis=1)
    time.sleep(0.1)
    initial_modeab = mc.communication.get_register('FBK_BISS1_SSI1_ITF_DATA', axis=1) & 0xFF
    ...
    mc.communication.set_register('FBK_BISS1_SSI1_ITF_CTL', READ_ACTION, axis=1)
    time.sleep(0.1)
    initial_out_msb_zero = mc.communication.get_register('FBK_BISS1_SSI1_ITF_DATA', axis=1) & 0xFF
    ...
    if final_out_msb_zero != initial_out_msb_zero:
        ...
        result = mc.communication.get_register('FBK_BISS1_SSI1_ITF_DATA', axis=1)
        print(
            f"Writing OUT_ZERO=0x{out_zero_code_biss:02X} and OUT_MSB=0x{out_msb_code:02X} on address 0x{ADDR_OUT_MSB_ZERO:02X}: result = {result}")
    ...
    mc.communication.set_register('FBK_BISS1_SSI1_ITF_CTL', READ_ACTION, axis=1)
    time.sleep(0.1)
    initial_out_lsb_modest = mc.communication.get_register('FBK_BISS1_SSI1_ITF_DATA') & 0xFF
    ...
    if final_out_lsb_modest != initial_out_lsb_modest:
        ...
        result = mc.communication.get_register('FBK_BISS1_SSI1_ITF_DATA', axis=1)
        print(
            f"Writing MODE_ST=RAW and OUT_LSB=0x{out_lsb_code:02X} on address 0x{ADDR_OUT_LSB_ST:02X}: result = {result}")
    ...
    mc.communication.set_register('FBK_BISS1_SSI1_ITF_CTL', READ_ACTION, axis=1)
    time.sleep(0.1)
    initial_test = mc.communication.get_register('FBK_BISS1_SSI1_ITF_DATA', axis=1) & 0xFF
    ...
    if initial_test != after_test:
        ...
        time.sleep(0.1)
        result = mc.communication.get_register('FBK_BISS1_SSI1_ITF_DATA', axis=1)
        print(f"Writing TEST=0x{set_test_value:02X} on address 0x{ADDR_TEST:02X}: result = {result}")
    ...
    mc.communication.set_register('FBK_BISS1_SSI1_ITF_CTL', READ_ACTION, axis=1)
    time.sleep(0.1)
    initial_mpc = mc.communication.get_register('FBK_BISS1_SSI1_ITF_DATA', axis=1) & 0xFF
...
def adjust_analog_parameters(master_param, nonius_param):
    ...
    new_gx_m = master_param.cosine_gain
    mc.communication.set_register('FBK_BISS1_SSI1_ITF_CTL', NO_ACTION, axis=1)
    ...
    new_voss_m = master_param.sine_offset
    mc.communication.set_register('FBK_BISS1_SSI1_ITF_CTL', NO_ACTION, axis=1)
    ...
    new_vosc_m = master_param.cosine_offset
    mc.communication.set_register('FBK_BISS1_SSI1_ITF_CTL', NO_ACTION, axis=1)
    ...
    new_gx_n = nonius_param.cosine_gain
    mc.communication.set_register('FBK_BISS1_SSI1_ITF_CTL', NO_ACTION, axis=1)
    ...
    new_voss_n = nonius_param.sine_offset
    mc.communication.set_register('FBK_BISS1_SSI1_ITF_CTL', NO_ACTION, axis=1)
    ...
    new_vosc_n = nonius_param.cosine_offset
    mc.communication.set_register('FBK_BISS1_SSI1_ITF_CTL', NO_ACTION, axis=1)
...
def read_master_nonius_parameters():
    # initial_master_adjustments = mu_3sl.AnalogTrackAdjustments()
    mc.communication.set_register('FBK_BISS1_SSI1_ITF_CTL', NO_ACTION, axis=1)
    mc.communication.set_register('FBK_BISS1_SSI1_ITF_ADDR', GX_M, axis=1)
    mc.communication.set_register('FBK_BISS1_SSI1_ITF_CTL', READ_ACTION, axis=1)
    time.sleep(0.1)
    # initial_master_adjustments.cosine_gain = mc.communication.get_register('FBK_BISS1_SSI1_ITF_DATA', axis=1)
    ...
    mc.communication.set_register('FBK_BISS1_SSI1_ITF_CTL', READ_ACTION, axis=1)
    time.sleep(0.1)
    # initial_master_adjustments.sine_offset = mc.communication.get_register('FBK_BISS1_SSI1_ITF_DATA', axis=1)
    ...
    mc.communication.set_register('FBK_BISS1_SSI1_ITF_CTL', READ_ACTION, axis=1)
    time.sleep(0.1)
    # initial_master_adjustments.cosine_offset = mc.communication.get_register('FBK_BISS1_SSI1_ITF_DATA', axis=1)
    ...
    mc.communication.set_register('FBK_BISS1_SSI1_ITF_CTL', READ_ACTION, axis=1)
    time.sleep(0.1)
    # initial_master_adjustments.phase = mc.communication.get_register('FBK_BISS1_SSI1_ITF_DATA', axis=1)
    phase = mc.communication.get_register('FBK_BISS1_SSI1_ITF_DATA', axis=1)

    initial_master_adjustments = mu_3sl.AnalogTrackAdjustments(cosine_gain, sine_offset, cosine_offset, phase)
    ...
    mc.communication.set_register('FBK_BISS1_SSI1_ITF_CTL', READ_ACTION, axis=1)
    time.sleep(0.1)
    # initial_nonius_adjustments.cosine_gain = mc.communication.get_register('FBK_BISS1_SSI1_ITF_DATA', axis=1)
    ...
    mc.communication.set_register('FBK_BISS1_SSI1_ITF_CTL', READ_ACTION, axis=1)
    time.sleep(0.1)
    # initial_nonius_adjustments.sine_offset = mc.communication.get_register('FBK_BISS1_SSI1_ITF_DATA', axis=1)
    ...
    mc.communication.set_register('FBK_BISS1_SSI1_ITF_CTL', READ_ACTION, axis=1)
    time.sleep(0.1)
    # initial_nonius_adjustments.cosine_offset = mc.communication.get_register('FBK_BISS1_SSI1_ITF_DATA', axis=1)
    ...
    mc.communication.set_register('FBK_BISS1_SSI1_ITF_CTL', READ_ACTION, axis=1)
    time.sleep(0.1)
    # initial_nonius_adjustments.phase = mc.communication.get_register('FBK_BISS1_SSI1_ITF_DATA', axis=1)
    nonius_phase = mc.communication.get_register('FBK_BISS1_SSI1_ITF_DATA', axis=1)

    initial_nonius_adjustments = mu_3sl.AnalogTrackAdjustments(nonius_cosine_gain, nonius_sine_offset, nonius_cosine_offset, nonius_phase)
...
def acquire_data():
    ...
    # mc.motion.set_operation_mode(PROFILE_VELOCITY_MODE, axis=1)
    # mc.motion.set_operation_mode(2, axis=1)
    ...
    # mc.motion.set_velocity(VELOCITY_SP)
    generator_freq = 0.5
    ...
    channel_data = [[] for register in POLLED_REGISTERS]
    ...
    try:
        while test_timeout > time.time():
            ...
            for idx, channel in enumerate(data):
                channel_data[idx].extend(channel)
    ...
    np.savetxt(output_file_name, np.asarray(splitted_raw_data), delimiter=",", fmt="%d",
               header="master_raw,nonius_raw", comments="")
    print(f"Data saved to {output_file_name}")
    return output_file_name

# --- Step 1: Connect to the drive (comment this section if the communication is already done via ML3) ---
mc = MotionController()
...
mc.communication.set_register('FBK_BISS1_SSI1_ITF_CTL', READ_ACTION, axis=1)
time.sleep(0.1)
revision_code_val = mc.communication.get_register('FBK_BISS1_SSI1_ITF_DATA', axis=1) & 0xFF
...
# TODO: Abs encoder should be configured as: frame size 36 bits, position and single turn bits 28,
#  start bit 8 for the calibration

# --- Step 3: Spin motor, read absolute position values from, convert into master and nonius raw data and calibrate
...
while iteration <= 3:
    ...
    # initial_master_adjustments, initial_nonius_adjustments = read_master_nonius_parameters()
    ...
    # if analyze_result.is_analog_analyses_valid():
    #     analyze_result.log(mu_3sl.AdjustmentMessageLogLevel.ERRORS)
    #     adjust generator frequency until no error is triggered
    ...
    adjust_analog_parameters(calibration.analog_master_track_adjustments(), calibration.analog_nonius_track_adjustments())
    print_analog_adjustments(calibration)
    print("\n")
...
mc.communication.set_register('FBK_BISS1_SSI1_ITF_CTL', READ_ACTION, axis=1)
time.sleep(0.1)
status1 = mc.communication.get_register('FBK_BISS1_SSI1_ITF_DATA', axis=1) & 0xFF
